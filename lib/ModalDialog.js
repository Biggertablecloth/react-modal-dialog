...
var ModalDialog = (function (_React$Component) {
  ...
  _createClass(ModalDialog, null, [{
    key: 'propTypes',
    value: {
      onClose: _propTypes2['default'].func, // required for the close button
      className: _propTypes2['default'].string, // css class in addition to .ReactModalDialog
      width: _propTypes2['default'].oneOfType([_propTypes2['default'].number, _propTypes2['default'].string]), // width
      topOffset: _propTypes2['default'].number, // injected by @centerComponent
      leftOffset: _propTypes2['default'].number, // injected by @centerComponent
      margin: _propTypes2['default'].number.isRequired, // the margin around the dialog
      children: _propTypes2['default'].node,
      componentIsLeaving: _propTypes2['default'].bool,
      style: _propTypes2['default'].object,
      left: _propTypes2['default'].number,
      recenter: _propTypes2['default'].func.isRequired,
      top: _propTypes2['default'].number,
      dismissOnBackgroundClick: _propTypes2['default'].bool
    },
    enumerable: true
  }, {
    key: 'defaultProps',
