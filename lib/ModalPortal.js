...
var ModalPortal = (function (_React$Component) {
  ...
  function ModalPortal() {
    ...
    this.componentWillUnmount = function () {
      ...
      if (_this._component && typeof _this._component.componentWillLeave == 'function') {
  ...
  _createClass(ModalPortal, null, [{
    key: 'propTypes',
    value: {
      onClose: _propTypes2['default'].func, // This is called when the dialog should close
      children: _propTypes2['default'].node,
      onModalDidMount: _propTypes2['default'].func, // optional, called on mount
      onModalWillUnmount: _propTypes2['default'].func },
    enumerable: true
  }]);
